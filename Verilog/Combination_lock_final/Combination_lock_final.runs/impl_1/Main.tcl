...
namespace eval ::optrace {
  variable script "D:/Software/Vivado/programs/Combination_lock_final/Combination_lock_final.runs/impl_1/Main.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet D:/Software/Vivado/programs/Combination_lock_final/Combination_lock_final.runs/synth_1/Main.dcp
...
OPTRACE "link_design" START { }
  link_design -top Main -part xc7a35tcsg324-3
...
OPTRACE "Write Bitstream: pre hook" START { }
  set src_rc [catch { 
    puts "source D:/Software/Vivado/programs/Combination_lock_final/name.tcl.txt"
    source D:/Software/Vivado/programs/Combination_lock_final/name.tcl.txt
  } _RESULT] 
  if {$src_rc} { 
    send_msg_id runtcl-1 error "$_RESULT"
    send_msg_id runtcl-2 error "sourcing script D:/Software/Vivado/programs/Combination_lock_final/name.tcl.txt failed"
    return -code error
  }
